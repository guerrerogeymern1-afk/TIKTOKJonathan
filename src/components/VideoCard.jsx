...
export default function VideoCard({ video, isActive }) {
  ...
  return (
    <div className={`relative w-full h-full md:h-[calc(100vh-2rem)] md:w-fit md:aspect-[9/16] md:rounded-2xl overflow-hidden bg-black flex items-center justify-center cursor-pointer group transition-all duration-500 ease-in-out ${showComments ? 'md:-left-[200px]' : 'md:left-0'}`} onClick={handleClick}>
